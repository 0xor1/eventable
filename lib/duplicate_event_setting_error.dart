...
class DuplicateEventSettingError extends Error{
  ...
  DuplicateEventSettingError(EventDetector this.detector, EventEmitter this.emitter, Type this.type, EventAction this.existingAction, EventAction this.newAction);
}